...
namespace Discord
{
    public static class ReactionExtentions
    {
        ...
        public static IReadOnlyList<Reaction> GetGuildReactions(this DiscordClient client, long guildId)
        {
            ...
            var reactions = resp.Deserialize<List<Reaction>>().SetClientsInList(client);
